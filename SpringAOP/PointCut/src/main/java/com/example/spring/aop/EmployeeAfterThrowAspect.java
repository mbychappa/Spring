...
@Aspect
public class EmployeeAfterThrowAspect {
 
	@AfterThrowing("getNamePointcut()")
    //Same as @AfterThrowing("execution(public String getName())")
    public void getNameAdvice(){
        System.out.println("Executing After Throw Advice on getName()");
    }
     
	 @AfterThrowing("getAllmethodsPointcut()")
	  //Same as @AfterThrowing("execution(* com.example.spring.aop.*.*(..))")
	  public void getAllMethodsAdvice(){
	        System.out.println("Executing Advice for all Methods");
	    }
	 
    @AfterThrowing("getAllServicemethodsPointcut()")
    //Same as @AfterThrowing("execution(* com.example.spring.aop.*Service.*())")
    public void getAllServiceMethodsAdvice(){
        System.out.println("Executing Advice on all EmployeeService methods");
    }
    
    @AfterThrowing("getSetStringemethodsPointcut()")
